...
export async function up(queryInterface, Sequelize) {
  await queryInterface.createTable('products', {
    ...
    category: { type: Sequelize.ENUM('Electronics', 'Books', 'Clothing', 'Home', 'Sports'), allowNull: false },
    price: { type: Sequelize.DECIMAL(10, 2), allowNull: false },
    seller: { type: Sequelize.UUID, allowNull: false, references: { model: 'users', key: 'id' },
      onUpdate: 'CASCADE',
      onDelete: 'CASCADE'
    },
