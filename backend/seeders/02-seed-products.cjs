    ...
    up: async (queryInterface, Sequelize) => {
        ...
        const products = [
            ...
            },
            {
                ...
                name: "Air Purifier",
                description:
                    "HEPA air purifier for large rooms up to 500 sq ft",
                category: "Home",
                price: 249.99,
                seller: userIds[1],
                createdAt: new Date(),
            ...
            },
            {
                ...
                name: "Dumbbells Set",
                description:
                    "Adjustable dumbbells set ranging from 5 to 50 pounds",
                category: "Sports",
                price: 299.99,
                seller: userIds[1],
                createdAt: new Date(),
            ...
            },
            {
                ...
                name: "Winter Jacket",
                description:
                    "Waterproof insulated winter jacket for extreme cold",
                category: "Clothing",
                price: 349.99,
                seller: userIds[2],
                createdAt: new Date(),
